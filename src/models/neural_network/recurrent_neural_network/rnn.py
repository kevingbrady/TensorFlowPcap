...
from keras.api.layers import BatchNormalization, UnitNormalization, LSTM, Dense
...
class RecurrentNeuralNet:
    ...
    name = "RecurrentNeuralNet"
    model_filepath = DOCKER_PREFIX + 'src/models/neural_network/recurrent_neural_net/RecurrentNeuralNet'
    ...
    def __init__(self, manager):
        ...
        self.classifier = Sequential([
            UnitNormalization(),
            LSTM(input_shape=(None, None, self.input_tensor.shape[1])),
